...
class ImportBmeWiha extends Command
{
// the name of the command (the part after "bin/console")
    protected static $defaultName = 'importWiha';
    ...
    private function importNewAssets($path)
    {
        ...
        $xml = new SimpleXMLElement('BmeWiha.xml', 0, TRUE);
        $counter = 0;
        ...
        foreach ($xml->T_NEW_CATALOG->ARTICLE as $result) {
            ...
            foreach ($eanList as $list) {
                if ($list->getEan() == $xmlEan) {
                    ...
                    if($checkFirstSixCharacters == "Wiha"){
                        $shortDescriptionVar = substr($shortDescriptionVar, 4);
                        $shortDescriptionVar = "Wiha " . $shortDescriptionVar;
                    }else{
                        $shortDescriptionVar = "Wiha " . $shortDescriptionVar;
                    }
