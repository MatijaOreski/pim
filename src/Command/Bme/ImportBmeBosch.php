...
class ImportBmeBosch extends Command
{
// the name of the command (the part after "bin/console")
    protected static $defaultName = 'importBosch';
            ...
            if ($counter <= 100) {
                ...
                foreach ($eanList as $list) {
                    if ($list->getEan() == $xmlEan) {
                        ...
                        if($checkFirstSixCharacters == "Bosch "){
                            $shortDescriptionVar = substr($shortDescriptionVar, 6);
                            $shortDescriptionVar = "Bosch " . $shortDescriptionVar;
                        }else{
                            $shortDescriptionVar = "Bosch " . $shortDescriptionVar;
                        }
