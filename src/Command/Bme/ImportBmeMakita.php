...
class ImportBmeMakita extends Command
{
// the name of the command (the part after "bin/console")
    protected static $defaultName = 'importMakita';
    ...
    private function importNewAssets($path)
    {
        ...
        $xml = new SimpleXMLElement('BmeMakita.xml', 0, TRUE);
        $counter = 0;
            ...
            if ($counter <= 10) {
                ...
                foreach ($eanList as $list) {
                    if ($list->getEan() == $xmlEan) {
                        ...
                        if($checkFirstSixCharacters == "Makita"){
                            $shortDescriptionVar = substr($shortDescriptionVar, 6);
                            $shortDescriptionVar = "Makita " . $shortDescriptionVar;
                        }else{
                            $shortDescriptionVar = "Makita " . $shortDescriptionVar;
                        }
