...
class ImportBmeGedore extends Command
{
// the name of the command (the part after "bin/console")
    protected static $defaultName = 'importGedore';
    ...
    private function importNewAssets($path)
    {
        ...
        $xml = new SimpleXMLElement('BmeGedore.xml', 0, TRUE);
        $counter = 0;
        ...
        foreach ($xml->T_NEW_CATALOG->ARTICLE as $result) {
            ...
            foreach ($eanList as $list) {
                if ($list->getEan() == $xmlEan) {
                    ...
                    if($checkFirstSixCharacters == "Gedore"){
                        $shortDescriptionVar = substr($shortDescriptionVar, 6);
                        $shortDescriptionVar = "Gedore " . $shortDescriptionVar;
                    }else{
                        $shortDescriptionVar = "Gedore " . $shortDescriptionVar;
                    }
