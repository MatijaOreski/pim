...
class ImportBmeSchneider extends Command
{
// the name of the command (the part after "bin/console")
    protected static $defaultName = 'importSchneider';
    ...
    private function importNewAssets($path)
    {
        ...
        $xml = new SimpleXMLElement('BmeSchneider.xml', 0, TRUE);
        $counter = 0;
            ...
            if ($counter <= 10) {
                ...
                foreach ($eanList as $list) {
                    if ($list->getEan() == $xmlEan) {
                        ...
                        // description part
                        $xmlTechnicalData = $result->ARTICLE_DETAILS->DESCRIPTION_LONG;
